...
export const PORTFOLIO_CATEGORIES: PortfolioCategory[] = [
  {
    ...
    projects: [
      ...
      { slug: "kitchen-11", slot: "pf_kitchens_11", title: "Кухня цвета мокко", material: "МДФ матовый, фурнитура Blum", price: "от 195 000 ₽", defaultImg: KITCHEN_IMG },
      { slug: "kitchen-12", slot: "pf_kitchens_12", title: "Угловая кухня с барной стойкой", material: "МДФ эмаль, акриловая столешница", price: "от 235 000 ₽", defaultImg: KITCHEN_IMG },
      { slug: "kitchen-13", slot: "pf_kitchens_13", title: "Кухня в стиле неоклассика", material: "МДФ с патиной, фрезеровка", price: "от 265 000 ₽", defaultImg: KITCHEN_IMG },
      { slug: "kitchen-14", slot: "pf_kitchens_14", title: "П-образная кухня с окном", material: "ЛДСП Egger, кварцевая столешница", price: "от 250 000 ₽", defaultImg: KITCHEN_IMG },
      { slug: "kitchen-15", slot: "pf_kitchens_15", title: "Кухня с открытыми полками", material: "Шпон дуба, фурнитура Hettich", price: "от 215 000 ₽", defaultImg: KITCHEN_IMG },
      { slug: "kitchen-16", slot: "pf_kitchens_16", title: "Прямая кухня в тёмных тонах", material: "МДФ soft-touch, встроенная техника", price: "от 205 000 ₽", defaultImg: KITCHEN_IMG },
      { slug: "kitchen-17", slot: "pf_kitchens_17", title: "Кухня с островом и подсветкой", material: "МДФ глянец, LED-подсветка", price: "от 340 000 ₽", defaultImg: KITCHEN_IMG },
      { slug: "kitchen-18", slot: "pf_kitchens_18", title: "Кухня для загородного дома", material: "Массив сосны, ЛДСП", price: "от 290 000 ₽", defaultImg: KITCHEN_IMG },
      { slug: "kitchen-19", slot: "pf_kitchens_19", title: "Компактная угловая кухня", material: "ЛДСП Egger, компактная фурнитура", price: "от 150 000 ₽", defaultImg: KITCHEN_IMG },
      { slug: "kitchen-20", slot: "pf_kitchens_20", title: "Кухня в средиземноморском стиле", material: "МДФ эмаль, открытые ниши", price: "от 225 000 ₽", defaultImg: KITCHEN_IMG },
    ],
  },
  {
    slug: "wardrobes",
